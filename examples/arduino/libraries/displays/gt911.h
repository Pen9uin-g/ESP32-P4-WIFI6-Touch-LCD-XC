...
#define EXAMPLE_PIN_NUM_TOUCH_RST       (GPIO_NUM_NC)  // Reset is not controlled by this polling driver
#define EXAMPLE_PIN_NUM_TOUCH_INT       (GPIO_NUM_NC)  // Interrupt is not used by this polling driver
