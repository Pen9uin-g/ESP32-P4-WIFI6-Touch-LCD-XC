 ...
 * ESP32-P4-WIFI6-Touch-LCD-XC DSI displays.
 *
 ...
 * streams RAW8 frames which the ISP pipeline converts to RGB565. Select the
 * target XC panel with CURRENT_SCREEN; this sketch uses the local display
 * configuration rather than a fixed panel profile.
 *
...
static void enableBacklight() {
  ...
  analogWrite(LCD_BACKLIGHT, 242);  // Match the BSP's 95% maximum brightness.
}
