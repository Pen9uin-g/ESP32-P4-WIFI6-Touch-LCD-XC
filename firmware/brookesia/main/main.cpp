...
extern "C" void app_main(void)
{
...

    {
        ...
        // The XC panels are circular (800x800 or 720x720).  The default
        // stylesheet uses percentage-sized layout and therefore follows the
        // BSP-selected panel geometry instead of the LCD-X portrait sizes.
        const auto &target_stylesheet = ESP_BROOKESIA_PHONE_DEFAULT_DARK_STYLESHEET();
